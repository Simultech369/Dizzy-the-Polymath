...
| Node/Python Council Bridge Contract | Schema and fixture gate for quarantined sidecar rehearsals; separates bridge payload integrity from bounty-task integrity, keeps sidecar responses rehearsal-only, and rejects live-execution claims without verified sandbox/egress proof (`docs/node_python_council_bridge_contract.md`, `docs/sidecar_sandbox_and_egress_boundary.md`, `npm run test:node-python-bridge-contract`) |
