...
export function runSimulation(initialState, parameters = {}, steps = 30) {
  let state = {
    reserves: initialState?.reserves ?? 1000,
    participants: initialState?.participants ?? 50,
    allocated_amount: initialState?.allocated_amount ?? 0,
    exited_count: initialState?.exited_count ?? 0,
  };
