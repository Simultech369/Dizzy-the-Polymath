...
const SECRET_PATTERNS = [
  ...
  [/\b([A-Z0-9_]{2,64}(?:API|TOKEN|SECRET|KEY|PASSWORD)[A-Z0-9_]{0,64})=([^\s]{6,})\b/gi, "$1=[REDACTED]"],
  [/\b(api[_-]?key|token|secret|password|passwd|authorization|cookie|credential|session)\s*[:=]\s*([^\s,;"']{6,})/gi, "$1=[REDACTED]"],
];
