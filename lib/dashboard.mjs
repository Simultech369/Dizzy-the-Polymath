...
import { buildContinuityReport, deleteClientContinuity, exportClientContinuity } from "./client_continuity.mjs";
...
<script src="/assets/dashboard-login.js" defer></script>
  ...
  app.post("/api/operator-continuity/delete", guard, (req, res, next) => {
    try {
