...
export const PROVIDER_CAPABILITY_PROFILES = Object.freeze({
  ...
  "muse-glimmer:latest": {
    ...
    expected_latency_band: "local_cpu_slow",
    preferred_lens: ["creative reasoning", "exploratory synthesis", "multimodal critique"],
    avoid_for: ["unverified release gates", "unproven review paths"],
    provider_boundary: "private_self",
    availability_status: "unverified_candidate",
    evidence_source: "ollama_library_watch_requires_local_pull",
  },

  // Frontier & OSS Candidate Watchlist (Unverified Candidates)
  "deepseek-v4-pro": {
    ...
    returns_auxiliary_only: false,
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["deep reasoning", "code architecture"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "deepseek_changelog_watch",
  },
  "deepseek-v4-flash": {
    ...
    returns_auxiliary_only: false,
    json_review_usable: false,
    expected_latency_band: "cloud_ultra_fast",
    preferred_lens: ["fast code triage", "lightweight review"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "deepseek_changelog_watch",
  ...
  "grok-4.5": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["challenger synthesis", "adversarial review"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "xai_announcement_watch",
  },
  "minimax-m3": {
    model_id: "minimax-m3",
    provider: "minimax",
    ...
    returns_auxiliary_only: false,
    json_review_usable: false,
    expected_latency_band: "cloud_medium",
    preferred_lens: ["long-context synthesis", "document critique"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "minimax_blog_watch",
  },
  "glm-5.2": {
    model_id: "glm-5.2",
    provider: "openrouter",
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_medium",
    preferred_lens: ["long-horizon coding", "open-sovereign critique"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "public_free",
    availability_status: "unverified_candidate",
    evidence_source: "zai_blog_watch",
  },
  "qwen3.6-35b-a3b": {
    ...
    preferred_lens: ["agentic code review", "multi-step reasoning"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "qwen_ai_blog_watch",
  },
  "command-a-plus-05-2026": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_medium",
    preferred_lens: ["sovereign agentic review", "tool-use critique"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "cohere_blog_watch",
  },
  "north-mini-code": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["fast code patch review"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "cohere_blog_watch",
  ...
  "mistral-medium-3.5": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["agentic code & logic review"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "mistral_news_watch",
  },
  "leanstral-1.5": {
    model_id: "leanstral-1.5",
    provider: "mistral",
    installed: false,
    callable: false,
    returns_normal_content: false,
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["formal verification", "math & logic proof"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "mistral_news_watch",
  ...
  "claude-opus-4-8": {
    ...
    returns_auxiliary_only: false,
    json_review_usable: false,
    expected_latency_band: "cloud_slow",
    preferred_lens: ["frontier architectural proof", "highest-judgment review"],
    avoid_for: ["private-self local-only review", "low-latency loops"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "anthropic_news_watch",
  },
  "claude-sonnet-5": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["balanced agentic code & review"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "anthropic_news_watch",
  ...
  "claude-fable-5": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_medium",
    preferred_lens: ["creative synthesis", "storytelling & narrative logic"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "anthropic_news_watch",
  ...
  "gpt-5.5": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_medium",
    preferred_lens: ["external ceiling comparator", "deep reasoning"],
    avoid_for: ["private-self local-only review", "strict cost bounds"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "openai_announcement_watch",
  },
  "gemini-3.1-pro-preview": {
    ...
    json_review_usable: false,
    expected_latency_band: "cloud_fast",
    preferred_lens: ["long-context synthesis", "custom tools"],
    avoid_for: ["private-self local-only review"],
    provider_boundary: "trusted_collaborator",
    availability_status: "unverified_candidate",
    evidence_source: "google_ai_docs_watch",
  },
...
export function getProviderCapabilityProfile(modelId = "", installedModels = new Set(), availabilityResult = null) {
  ...
  const callable = base.provider === "ollama"
    ? Boolean(installed || availabilityCallable)
