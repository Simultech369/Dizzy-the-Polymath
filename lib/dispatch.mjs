...
async function maybeChat(msg) {
  ...
  const { systemPrompt: baseSystemPrompt, compression_ratio } = getCachedChatSystemPrompt({ trustZone: getTrustZone(msg) });
  ...
  if (backend === "gemini") {
    try {
      ...
      return attachCapabilityReceipt({ kind: "reply", text: finalText }, msg, { ...retrievalAudit, compression_ratio });
    } catch (e) {
