...
import { evaluateBatch, validateTrajectoryEvalReceipt } from "./trajectory_evaluator.mjs";
...
export function appendTrajectory(input, opts = {}) {
  ...
  const admissionReceipt = evaluateBatch([input], opts.trajectoryEvalPolicy);
  ...
  const ledgerRecord = { ...trajectory, admission_evidence: admissionEvidence, admission_receipt: admissionReceipt };
