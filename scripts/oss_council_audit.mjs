...
async function runAudit() {
  ...
  const targetFiles = [
    ...
    "lib/trajectory_replay_simulator.mjs",
    "lib/tools.mjs",
    "lib/trace_chain.mjs",
    ...
    "scripts/routing_policy_test.mjs",
    ...
    "scripts/trajectory_replay_simulator_test.mjs",
    ...
    "scripts/context_assembler_test.mjs",
    "lib/context_assembler.mjs",
    "lib/context_sources.mjs",
    ...
    "scripts/external_gateway_posture_test.mjs",
  ...
  const testSuites = [
    ...
    { name: "Capability Routing Policy Suite", script: "scripts/routing_policy_test.mjs" },
    ...
    { name: "External Gateway Posture Suite", script: "scripts/external_gateway_posture_test.mjs" },
    ...
    { name: "Dashboard Public Surface Suite", script: "scripts/dashboard_public_surface_test.mjs" },
    { name: "Public View Readiness Suite", script: "scripts/public_view_readiness_test.mjs" },
    ...
    { name: "Trajectory Replay Simulator Suite", script: "scripts/trajectory_replay_simulator_test.mjs" },
