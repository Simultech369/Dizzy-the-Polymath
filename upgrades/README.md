...
- `active`: [privilege-split.md](active/privilege-split.md), [selection-pressure.md](active/selection-pressure.md), [tension-map.md](active/tension-map.md)
- `integrated`: [W-0004-continuity-lifecycle.md](active/W-0004-continuity-lifecycle.md), [civic-sieve.md](active/civic-sieve.md), [drift-check-evidence.md](active/drift-check-evidence.md), [friction-ledger.md](active/friction-ledger.md), [memory-metadata.md](active/memory-metadata.md), [per-zone-capability-lists.md](active/per-zone-capability-lists.md), [refinement-discipline.md](active/refinement-discipline.md), [trajectory-distillery.md](active/trajectory-distillery.md)
...
1. Strengthen the logical untrusted-context boundary.
2. Evaluate an optional local memory sidecar only after local markdown/JSONL contracts hit a concrete limit.
