...
- `active`: [drift-check-evidence.md](active/drift-check-evidence.md), [privilege-split.md](active/privilege-split.md), [selection-pressure.md](active/selection-pressure.md), [tension-map.md](active/tension-map.md)
...
1. Add auditable evidence to report-only drift scans.
2. Strengthen the logical untrusted-context boundary.
3. Evaluate an optional local memory sidecar only after local markdown/JSONL contracts hit a concrete limit.
