...
- Cryptographic verification receipts for every transition
- Human confirmation on irreversible or external actions
- An offline, deterministic verification Council
...
2. **Not an Agent Framework**: Native StateM + cryptographic receipts, not a LangChain/LangGraph-shaped platform.
...
9. **Not Notebook Portfolios**: Runnable gates, immutable receipts, and honest documentation.
